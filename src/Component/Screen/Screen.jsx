...
//             <TaskSection title="To-Do" color="bg-blue-500" tasks={todoTasks} />
//             <TaskSection
//               title="In Progress"
//               color="bg-yellow-500"
//               tasks={inProgressTasks}
//             />
//             <TaskSection title="Done" color="bg-green-500" tasks={doneTasks} />
//           </div>
//         </div>
//       </div>
//     </div>
  ...
  const handleDragEnd = (event) => {
    ...
    if (sourceContainer === destinationContainer) {
      if (sourceContainer === "todo") {
        const oldIndex = newTodoTasks.findIndex(
        ...
        const oldIndex = newDoneTasks.findIndex(
          (task) => task.id === active.id
        );
      ...
      <div className="mockup-window bg-base-200 border ml-3">
        <div className="min-h-screen bg-gray-100 dark:bg-gray-800 p-6">
          <div className="flex justify-between w-11/12 mx-auto">
            ...
            <div>
              <button
                className="bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-2 px-6 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 lg:mr-9 lg:mb-0 mb-2 lg:ml-0 ml-4"
